...
* *****
    ...
    - "If" somethng is true, do "this thing"
*/
...
if(weather < 70 && rain != false) { // rain == true     && rain
...
if(cookTime === 45) {
    ...
    console.log(`It has only been ${cookTime} minutes. Wait another 5 - 15 minuets.`);
    // console.log('It has only been ' + cookTime + ' minutes. Wait another 5-15 minutes.');
} else if(cookTime >=20) {
    console.log(`It has only been ${cookTime} minutes. Wait another 10 - 25 minuets.`);
} else {
...
//    (1)                           (2)                            (3)
myName === 'Clay' ? console.log(`Hello, my name is ${myName}.`) : console.log(`Hello, is your name ${myName}?`);
...
var lampOn = (daytime=true) ? (true "The lamp is on during the day") : ((daytime=false) ? (true "The lamp is on during the night"): (else "The lamp is off during the night")) [else if "The lamp is off during the day"]
*/
...
switch(instructor) {
    ...
    case 'Josh' :
        ...
        break;
    default :
        console.log(`${instructor} Sorry, I can't find what ${instuctor} teaches at this time.`);
