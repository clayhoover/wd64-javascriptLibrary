...
//let x = 1;    // Global becuase no functions
...
console.log(`Before reassinging fucntion: ${a}`);
reassign();
console.log(`After reassinging fucntion: ${a}`);
...
// statement lie "if" or loops don't create a new scope. If a variable is defined inside a block statement, it will remain in that scope. However, we can utilize let and const as keywords to help us control how our variable are viewed.