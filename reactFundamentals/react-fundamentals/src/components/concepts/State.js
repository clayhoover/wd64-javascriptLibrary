        ...
        <div classNam="main">
            <div className="mainDiv">
                <ul>
                    ...
                    <dt>Triggrs Re-renders</dt>
                    <dd>Like with props chages, changing the state of a component re-renders the whole component.</dd>
                </ul>
            </div>
        </div>
    );
...
function StateExample () {
    ...
    return(
        <div>
            <input value={text} on Change={e => setText(e.target.value)} />
            <br />
