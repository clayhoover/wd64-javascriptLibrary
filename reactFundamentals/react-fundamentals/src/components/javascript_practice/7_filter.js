const instructors = [
    {name: 'Aaron', specialty: 'Entemology', medals: 7},
...
// If done correctly, in your terminal you should see after console logging instructorInfo -> { name: 'Aaron', specialty: 'Entemology', medals: 7}
const instructorInfo = instructors.filter(instructor => instructor.name='Aaron');
console.log(instructorInfo)      // Idk