        ...
        <div className="main">
            <div className="mainDiv">
                ...
                <ul>
                    ...
                    <li>We have tried to collect the very bst resources for this app, and we have cited those <link to="/resources">here</link>.</li>
