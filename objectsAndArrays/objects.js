...
console.log('Episodes', netflix.season1.seasonInfo.episodeInfo[3].episodeName);
...
// We are accessing the keys within our object by a specfic name within our square bracket. The key name that is passed needs to be wrapped in quotes as all keys in an object are strings.
...
console.log(baking[garden['vegetable']])  // here we are saying the same thing as we did above, except we are passing information from our object. gardn['vegetable'] is the same as 'zucchini' up above.
